...
def main():
	try:
		...
		print("0. Day difference between Gregorian (Anno Infini) Calendar and Julian Calendar")
		
		print("!. 400-cycle indexing lists first day and last days")
		print("?. Guidelines!")

		print("\nNote: The calendar used in this program is Perfect Gregorian Algorithm (Anno Infini)")
		print("\n\nAnd this completely used Astronomical/ISO 8601 System >> 0-Based Epoch")
		print("\nExtra Notes: year 0 = 1 BC/BCE, -1 = 2 BC/BCE, etc!")
		print("\nAnd also pay special attention to \" # \" symbol and/or along if you want to input cycle number under 1 (1st and improper ordinal numbers)!")
...
def guide():
	...
	print("Or trying other numbers like 9 - year cycle or Novennium, runs from 0 - 8, 9 - 17, or currently this case, 2016 - 2024")
	...
	print("\n\n----------------------------------------------------------------")
	print("[!] Encountering cycle number or year number:")
	print("\nCycle number or year number (in the same cycle) are counted ordinally from 1 (as 1st) and so on, as also explained above.")
	...
	print("But to make sure, the main menu before has its guide or instruction on how you use the i-th year cycle under number 1")
	print("\n\nPlease pay special attention with the HASHTAG SYMBOL \" # \", it indicates the substitution of the ordinal/positional year number\nwhich is one higher than the actual either year value, cycle value, or remainder of the year when divided by the n - year cycle")
	print("\n\nThank you!")
...
def menu0():
	try:
		os.system('clear') # clear the screen first
		print("0. Day difference between Gregorian (Anno Infini) Calendar and Julian Calendar") # Show the name of the menu each operation
		print("\n")
